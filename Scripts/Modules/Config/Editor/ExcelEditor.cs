...
public class ExcelEditor : EditorWindow
{
    ...
    /// 模板存放位置
    /// </summary>
    static string scriptsPath { get { return UnityEngine.Application.dataPath + basePath + "Scripts/"; } } 

    /// <summary>
    /// json文件存放位置
    /// </summary>
    static string jsonPath { get { return UnityEngine.Application.dataPath + basePath + "Resources/";} } 
       
    /// <summary>
    /// 表格存放位置
    /// </summary>
    static string tablePath { get { return UnityEngine.Application.dataPath + basePath + "Table/"; } } 
